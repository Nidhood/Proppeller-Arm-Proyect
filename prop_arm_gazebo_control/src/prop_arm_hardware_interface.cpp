...
namespace prop_arm_gazebo_control
{
    ...
    PropArmHardware::export_state_interfaces()
    {
        ...
        state_interfaces.emplace_back(
            "arm_link_joint", hardware_interface::HW_IF_POSITION, &angle_);
        state_interfaces.emplace_back(
            "arm_link_joint", hardware_interface::HW_IF_VELOCITY, &velocity_);
    ...
    PropArmHardware::export_command_interfaces()
    {
        ...
        command_interfaces.emplace_back(
            "arm_link_joint", hardware_interface::HW_IF_POSITION, &command_);
