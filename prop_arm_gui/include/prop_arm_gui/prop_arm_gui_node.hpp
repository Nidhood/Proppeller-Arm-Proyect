...
public:
  ...
  void startStepTest(double angle_low_deg, double angle_high_deg,
...
private:
  ...
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr sim_ref_angle_cmd_pub_;
  rclcpp::Publisher<std_msgs::msg::UInt16>::SharedPtr sim_pwm_cmd_pub_;
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr sim_auto_mode_pub_;
